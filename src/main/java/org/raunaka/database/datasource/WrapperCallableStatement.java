...
public class WrapperCallableStatement extends WrappedPreparedStatement implements CallableStatement {

    private final CallableStatement callableStatement;

    public WrapperCallableStatement(CallableStatement callableStatement, DBMetrics dbMetrics) {
        super(callableStatement, dbMetrics);
        this.callableStatement = callableStatement;
    }

    @Override
    public boolean execute() throws SQLException {
        Timer.Context context = dbMetrics.getStoredProcTimer().time();
        try {
